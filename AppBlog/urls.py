...
from .views import inicio, buscarpost, buscar,  Home,  PostsList, PostDetail, PostCreate, PostUpdate, PostDelete
from .views import AutorList, AutorCreate, AutorUpdate, AutorDelete
from .views import CategoriaList, CategoriaCreate, CategoriaDelete, CategoriaUpdate

urlpatterns = [
    path('', inicio, name='inicio'),
    path('home/', Home.as_view(), name='home'),
    path('home', buscarpost, name='buscar'),
    path('post_search/', buscar),
